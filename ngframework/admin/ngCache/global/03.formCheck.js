	...
	launch: function(url, type, data) {
        ...
        checkByType: function(value, type){
            ...
            switch(type){
				...
				case 'isSelected':return (value.val()!='')?false:true;break;
				case 'newAccount' : res = false;
						...
						return eval(res);
						break;
				case 'isSame' : return (jQuery.trim(value.val())==$('input[name=password]').val()?false:true);break;
			}
...
$(document).ready(function(){
    $('form.formCheck').submit(function(){
        ...
        $('input, textarea, select',this).not('[type=submit], .inactive').each(function(){
